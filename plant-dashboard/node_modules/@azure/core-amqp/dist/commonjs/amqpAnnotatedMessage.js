...
exports.AmqpAnnotatedMessage = {
    ...
    toRheaMessage(msg) {
        const rhMsg = {
            ...messageProperties_js_1.AmqpMessageProperties.toRheaMessageProperties(msg.properties || {}),
            ...messageHeader_js_1.AmqpMessageHeader.toRheaMessageHeader(msg.header || {}),
            body: msg.body,
